...
import { TemplateScopeType } from '../model/models';
...
export class TemplatesService implements TemplatesServiceInterface {
     ...
     * @param reportProgress flag to report request and response progress.
     */
    public templatesGet(scopeType: Array<TemplateScopeType>, templateTypes?: Array<TemplateType>, limit?: number, offset?: number, observe?: 'body', reportProgress?: boolean, options?: {httpHeaderAccept?: 'application/json'}): Observable<Array<Template>>;
    public templatesGet(scopeType: Array<TemplateScopeType>, templateTypes?: Array<TemplateType>, limit?: number, offset?: number, observe?: 'response', reportProgress?: boolean, options?: {httpHeaderAccept?: 'application/json'}): Observable<HttpResponse<Array<Template>>>;
    public templatesGet(scopeType: Array<TemplateScopeType>, templateTypes?: Array<TemplateType>, limit?: number, offset?: number, observe?: 'events', reportProgress?: boolean, options?: {httpHeaderAccept?: 'application/json'}): Observable<HttpEvent<Array<Template>>>;
    public templatesGet(scopeType: Array<TemplateScopeType>, templateTypes?: Array<TemplateType>, limit?: number, offset?: number, observe: any = 'body', reportProgress: boolean = false, options?: {httpHeaderAccept?: 'application/json'}): Observable<any> {
